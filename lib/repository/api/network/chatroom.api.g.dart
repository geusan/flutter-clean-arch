...
part of 'chatroom.api.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ResponseOpenChatroomDto _$ResponseOpenChatroomDtoFromJson(
        Map<String, dynamic> json) =>
    ResponseOpenChatroomDto(
      url: json['url'] as String,
    );

Map<String, dynamic> _$ResponseOpenChatroomDtoToJson(
        ResponseOpenChatroomDto instance) =>
    <String, dynamic>{
      'url': instance.url,
    };
...
class _ChatroomApi implements ChatroomApi {
  _ChatroomApi(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
